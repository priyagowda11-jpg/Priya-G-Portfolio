        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="reveal">
            <p className="text-gray-300 text-base leading-relaxed mb-5">
              I am <span className="text-white font-semibold">Priya G</span>, an Electrical and Electronics Engineering undergraduate at{" "}
              <span style={{ color: "#F97316" }} className="font-medium">Rajarajeswari College of Engineering</span> (Class of 2027).
            </p>
            <p className="text-gray-400 text-sm leading-relaxed mb-5">
              I build intelligent systems that sit at the intersection of hardware and software — combining AI, IoT sensors, and embedded microcontrollers to solve real engineering problems. From data analysis and fraud detection algorithms to smart voting systems and live web platforms, I turn ideas into working systems.
            </p>
