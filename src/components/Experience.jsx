...
import { FaBriefcase, FaCheckCircle, FaCode, FaLayerGroup, FaChartBar } from "react-icons/fa";

const dataAnalystAchievements = [
  "Analyzing real datasets to extract actionable business insights",
  "Building interactive dashboards and reports using Power BI",
  "Extracting and structuring tabular data with Tableau",
  "Collaborating with cross-functional teams on data-driven decisions",
];

const dataAnalystTech = ["Python", "Excel", "Power BI", "Tableau", "SQL", "Pandas"];
...
const expertise = [
  { icon: FaCode, title: "AI & Data Analytics", desc: "Analyzing data and building predictive insights using Python, Pandas, and Power BI for real-world business and research applications.", level: 78, color: "#F97316" },
          ...
          <div className="reveal flex flex-col gap-8">
            ...
            <div className="dark-card p-7 h-full" style={{ borderColor: "rgba(249,115,22,0.2)" }}>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-white font-semibold text-xl">Data Analyst Intern</h3>
                  <p style={{ color: "#F97316" }} className="font-medium text-sm mt-0.5">Elythra EduFi Tech Solutions</p>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-xs font-mono px-2 py-0.5 rounded-none"
                      style={{ background: "rgba(239,68,68,0.1)", color: "#EF4444", border: "1px solid rgba(239,68,68,0.2)" }}>
                      Ongoing
                    </span>
                    <span className="text-gray-500 text-xs font-mono">4 Months</span>
                  </div>
                </div>
              </div>

              <p className="text-gray-400 text-sm leading-relaxed mb-5">
                Currently interning as a Data Analyst, working with real datasets, dashboards, and reporting tools to drive data-informed decisions.
              </p>

              {/* Achievements */}
              <div className="flex flex-col gap-2.5 mb-5">
                {dataAnalystAchievements.map((a, i) => (
            ...
            {/* Full Stack Web Dev Intern card */}
            <div className="dark-card p-7 h-full" style={{ borderColor: "rgba(249,115,22,0.2)" }}>
              {/* Header */}
              <div className="flex items-start gap-4 mb-6">
                <div className="w-14 h-14 flex items-center justify-center flex-shrink-0"
