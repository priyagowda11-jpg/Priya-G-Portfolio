...
import { FaGithub, FaExternalLinkAlt, FaRobot, FaShieldAlt, FaBolt, FaLock, FaInfoCircle, FaMicrochip, FaUserShield, FaHandsHelping } from "react-icons/fa";

const projects = [
  {
    id: "01", title: "AeroGrid AI", category: "IoT + AI",
    description: "Real-time monitoring dashboard streaming ESP32 sensor data into a live React interface for instant visibility into environmental and system conditions.",
    techs: ["ESP32", "Python", "Flask", "React", "Firebase"],
    github: null, live: "https://aerogrid-ai-henna.vercel.app/",
    icon: FaMicrochip, color: "#F97316", confidential: false,
  },
  {
    id: "02", title: "SecureOne", category: "Security",
    description: "Secure web application demonstrating robust authentication and data-protection practices, built to safeguard user information end-to-end.",
    techs: ["Python", "Flask", "JavaScript"],
    github: null, live: "https://secureone-system.onrender.com",
    icon: FaUserShield, color: "#EF4444", confidential: false,
  },
  {
    id: "03", title: "AI Fraud Detection System", category: "AI / Fraud Detection",
    description: "Intelligent fraud detection engine using AI algorithms to analyze transaction patterns, detect anomalies, and flag suspicious activities in real-time with a Flask REST API.",
    techs: ["Python", "Pandas", "Flask"],
    github: "https://github.com/priyagowda11-jpg/ai-fraud-detection", live: null,
    icon: FaRobot, color: "#F97316", confidential: false,
  },
  {
    id: "04", title: "Voting System", category: "IoT + Security",
    ...
    github: null, live: "https://voting-system-ozpz.onrender.com/login",
    icon: FaShieldAlt, color: "#EF4444", confidential: false,
  },
  {
    id: "05", title: "Smart EV Charger App", category: "IoT + AI + Mobile",
    description: "EV charging station finder with live maps, slot booking, queue management, and AI prediction for new station locations.",
    techs: ["Flutter", "Firebase", "Node.js", "Python Flask"],
    github: null, live: null, icon: FaBolt, color: "#EF4444", confidential: false,
    status: "Completed",
  },
  {
    id: "06", title: "Asha Worker Website", category: "Web Development",
    description: "Live website built for a social welfare organisation, delivered as a real client project during undergraduate studies.",
    techs: ["React", "HTML/CSS", "JavaScript"],
    github: null, live: null, icon: FaHandsHelping, color: "#F97316", confidential: false,
    status: "Ongoing",
  },
];
  ...
  return (
    <div ref={ref} onMouseMove={onMove} onMouseEnter={() => setHov(true)} onMouseLeave={onLeave}
      ...
      <div className="relative z-20 flex flex-col h-full">
        ...
        {project.status && (
          <span className="self-start text-xs font-mono px-2.5 py-1 mb-4"
            style={{
              background: project.status === "Completed" ? "rgba(249,115,22,0.1)" : "rgba(239,68,68,0.1)",
              color: project.status === "Completed" ? "#F97316" : "#EF4444",
              border: `1px solid ${project.status === "Completed" ? "rgba(249,115,22,0.2)" : "rgba(239,68,68,0.2)"}`,
            }}>
            {project.status}
          </span>
        )}
          ...
          <div className="flex items-center gap-4">
            ...
            {project.live && (
              <a href={project.live} target="_blank" rel="noreferrer"
                ...
                <span className="group-hover:underline">Live Site</span>
              </a>
            )}
  ...
  return (
    <section id="projects" className="py-24" style={{ background: "#080808" }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 reveal mb-6">
