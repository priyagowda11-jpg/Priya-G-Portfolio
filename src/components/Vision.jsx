...
const pillars = [
  { icon: FaBrain, title: "AI & Data Analytics Systems", desc: "Building predictive models and intelligent algorithms that learn from data and make real-world decisions autonomously.", color: "#F97316" },
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="reveal mb-14 text-center">
          ...
          <p className="text-gray-400 text-base leading-relaxed max-w-2xl mx-auto">
            I aim to build <span style={{ color: "#F97316" }} className="font-semibold">AI & Data Analytics powered systems</span> and{" "}
          ...
          <div className="dark-card p-6 flex flex-wrap items-center justify-between gap-6"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm font-mono">internships · research · AI & Data Analytics projects · collaborations</p>
              </div>
            </div>
