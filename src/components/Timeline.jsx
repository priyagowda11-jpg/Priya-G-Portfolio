...
import { FaGraduationCap, FaBriefcase, FaTrophy, FaCode, FaFlask, FaSearch, FaChartBar } from "react-icons/fa";
...
const events = [
  ...
  {
    year: "2024-2025", month: "September",
  ...
  {
    year: "2025", month: "Completed",
    title: "Smart EV Charger App", sub: "Independent Project",
    desc: "Built a Smart EV Charger app with Flutter, Firebase, and AI-driven station prediction — kept private for now.",
    icon: FaFlask, color: "#F97316", side: "left",
  },
  {
    year: "2026", month: "Ongoing",
    title: "Asha Worker Website", sub: "Client Project — NGO",
    desc: "Building a live website for a social welfare organisation as a 3rd-year student — a real client project with real impact.",
    icon: FaCode, color: "#EF4444", side: "right",
  },
  {
    year: "2026", month: "Ongoing",
    title: "Data Analyst Internship", sub: "Elythra EduFi Tech Solutions — 4 Months",
    desc: "Currently interning as a Data Analyst, working with real datasets, dashboards, and reporting tools to drive data-informed decisions.",
    icon: FaChartBar, color: "#F97316", side: "left",
  },
];
